...
from .views import ContactMessageViewSet, EventViewSet, LoginViewSet, CustomerReviewViewSet, BooknowViewSet, ActivityViewSet, ActivityDetailsViewSet, RegisterViewSet
